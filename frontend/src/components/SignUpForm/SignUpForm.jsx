...
function SignUpForm({ onError }) {
  ...
  return (
    ...
    <div class="container flex  justify-center min-h-fit px-6 mx-auto  my-20">
        <form class="w-1/2">
            ...
            <div class="flex items-center justify-center mt-6">
                ...
                <a href="#" class="w-1/3 pb-4 font-medium text-center text-gray-800 capitalize border-b-2 border-coral-red dark:border-blue-400 dark:text-white">
                    sign up
                </a>
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 text-center ">
                    <a href="#/login" class="text-sm text-coral-red hover:underline dark:text-blue-400">
